...
<div class="container-fluid">
    <div class="animated fadeIn">
        <div class="row" >
            ...
            <div class="col-md-12">
                <div class="card">
                <div class="card-header"><i class="fa fa-align-justify"> จัดการทักษะงานสถานประกอบการ</div></i>
                    <div class="card-body">
                    <?php 
                        if($status){
                                        ...
                                        <div class="card-body">
                                            ...
                                            <?php } ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="skill_name" name="skill_name" class="form-control" value="<?php echo @$skill_by_skill_id['skill_name'];?>" placeholder="กรุณากรอก" required>
                                                </div>
