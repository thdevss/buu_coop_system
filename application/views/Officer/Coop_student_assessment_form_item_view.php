                            ...
                            <?php foreach($coop_student_questionnaire_item as $row) { ?>
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <a href="<?php echo site_url('officer/Assessment_coop_student_Form/delete_coop_student_questionnaire_item/'.$row['coop_student_questionnaire_item_id']);?>" class="btn btn-danger" onclick="return confirmDelete(this)"><i class="icon-trash"></i> ลบ</a>
                                </td>
                              </tr>
