                    ...
                    <div class="card-header">
                      ...
                      <table class="table table-bordered " >
                            ...
                            <?php foreach($coop_student_questionnaire_item as $row) { ?>
                              ...
                              <tr>
                                <td><?php echo $row['coop_student_questionnaire_item_number'];?></td>
                                <td><?php echo $row['coop_student_questionnaire_item_type'];?></td>
      ...
      <div class="modal-header">
        <h4 class="modal-title">เพิ่มหัวข้อย่อยการประเมิน</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <form action="<?php echo site_url('Officer/Coop_student_assessment_form/add_coop_student_questionnaire_item/'.$subject['coop_student_questionnaire_subject_id']);?>" method="post">
      ...
      <div class="modal-header">
        <h4 class="modal-title">แก้ไขหัวข้อย่อยการประเมิน</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <form action="<?php echo site_url('Officer/Coop_student_assessment_form/update_coop_student_questionnaire_item/'.$subject['coop_student_questionnaire_subject_id']);?>" method="post">
              <div class="modal-body">
...
function call_assessment_item(item_id) {
  ...
  jQuery.get( SITE_URL+"/Officer/Coop_student_assessment_form/get_ajax_item/"+item_id, function( result ) {
    ...
    jQuery("#item_id").val(data.coop_student_questionnaire_item_id)
    jQuery("#item_description").val(data.coop_student_questionnaire_item_description)

    if(data.coop_student_questionnaire_item_type == 'score') {
      jQuery("#type_score").prop('checked', true);
    }
    if(data.coop_student_questionnaire_item_type == 'comment') {
